                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal" enctype="multipart/form-data" method="POST" action="{{ route('kendaraan.store')}}">
                                    @csrf
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="nama_kendaraan" type="text" class="form-control{{ $errors->has('nama_kendaraan') ? ' is-invalid' : '' }}" name="nama_kendaraan"
                                                value="{{  old('nama_kendaraan')  }}" required autofocus> @if ($errors->has('nama_kendaraan'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="plat_nomor" type="text" class="form-control{{ $errors->has('plat_nomor') ? ' is-invalid' : '' }}" name="plat_nomor"
                                                value="{{  old('plat_nomor')  }}" required autofocus> @if ($errors->has('plat_nomor'))
                                            <span class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea placeholder="tulis deskripsi kendaraan anda disini" name="deskripsi" id="deskripsi" cols="30" rows="10" class="form-control{{ $errors->has('deskripsi') ? ' is-invalid' : '' }}"></textarea>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input id="harga_sewa" type="text" class="form-control{{ $errors->has('harga_sewa') ? ' is-invalid' : '' }}" name="harga_sewa"
                                                value="{{  old('harga_sewa')  }}" required autofocus> @if ($errors->has('harga_sewa'))
                                            <span class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input id="gambar_kendaraan" type="file" class="form-control{{ $errors->has('gambar_kendaraan') ? ' is-invalid' : '' }}" name="gambar_kendaraan"
                                                autofocus> @if ($errors->has('gambar_kendaraan'))
                                            <span class="invalid-feedback">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <input id="foto_stnk" type="file" class="form-control{{ $errors->has('foto_stnk') ? ' is-invalid' : '' }}" name="foto_stnk"
                                                autofocus> @if ($errors->has('foto_stnk'))
                                            <span class="invalid-feedback">
